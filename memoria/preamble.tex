...
\lstdefinelanguage{JavaScript}{
    keywords={break, const, continue, delete, do, while, export, for, in, function, if, else, import, let, new, return, switch, case, try, catch, typeof, var, void, while, with, yield, async, await},
...
\lstdefinelanguage{Rust}{
    ...
    keywordstyle=\color{magenta}\bfseries,
    ndkeywords={u8, u16, u32, u64, u128, usize, i8, i16, i32, i64, i128, isize, f32, f64, char, str, bool, Option, Result, String, Vec},
...
\usepackage{rotating} % To rotate elements (e.g., tables)
\usepackage{float} % For advanced float positioning, like [H]
\usepackage{pgfgantt} % To draw Gantt charts
