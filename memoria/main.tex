...
\author{Marc Piñeiro Selas}             % Your name,                          \authorname
...
\supervisorA{Josep Soler}       % Name of supervisor 1,               \supnameA
\supervisorAmail{josep.soler@udg.edu}         % Email address of supervisor 1,      \supmailA
...
\department{INFORMÀTICA, MATEMÀTICA APLICADA I ESTADÍSTICA} 
                                        % Department,                         \deptname
