...
public class DetailsInfo {
    ...
    public DetailsInfo(UUID id, String name, String type, Boolean isDirectory, UUID parent, Date createdAt, Date updatedAt, String mimeType, String accessLevel, Boolean shared, Date deletedAt, Date clientDeletedAt, String ownerUserName, String ownerUserEmail, UUID ownerUserId, Date expirationDate) {
        this.id = id;
        this.name = name;
        this.type = type;
